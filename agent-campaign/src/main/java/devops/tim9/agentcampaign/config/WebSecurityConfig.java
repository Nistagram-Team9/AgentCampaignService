...
import devops.tim9.agentcampaign.config.domain.LoginEvent;
...
import devops.tim9.agentcampaign.service.VerificationTokenService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
			...
			.antMatchers("/campaigns/**").permitAll()
